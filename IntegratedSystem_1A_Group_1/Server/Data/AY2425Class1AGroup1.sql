...
--
-- 主機： 127.0.0.1
-- 產生時間： 2025 年 06 月 30 日 09:53
-- 伺服器版本： 10.4.32-MariaDB
-- PHP 版本： 8.2.12
create database if not exists `AY2425Class1AGroup1` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;
...
('C00010', 'Julia Roberts', '64124c539df34d10f107326e9018cf6e2b0f985da95596ee541b1ff9d79cafe2', '963 Chestnut St', 'julia@example.com', '12345678910', 'USA', 1);
...
('O00001', 'Q00001', '2025-05-15', '2025-05-20', 'C00001', 1000.00, 'Created', 'First order', 'Started', '2025-05-01', '2025-05-31', '2025-06-30'),
...
('Q00003', '2025-05-17', 'C00003', 1500.00, '45 days', 'Third quotation', 'Finalized');
...
CREATE TABLE `rawmaterial` (
  ...
  `stockStatus` varchar(15) NOT NULL,
...
('TEST14', 'test', 0, 'kg', 100, 'LOW_STOCK', 50.00, '2025-06-23'),
('TEST15', 'test', 0, 'kg', 100, 'LOW_STOCK', 13.00, '2025-06-25');
